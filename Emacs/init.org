...
=vterm-mode=, =dired-mode=, =magit-mode=, =eat-mode=, =agent-shell-mode=, =agent-shell-diff-mode=, =neotree-mode=
...
(leaf evil
  ...
  :config
  (evil-mode 1)
  (dolist (mode '(vterm-mode dired-mode magit-mode imenu-list-major-mode eat-mode agent-shell-mode agent-shell-diff-mode neotree-mode))
